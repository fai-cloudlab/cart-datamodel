...
/**
 * Point Of Sale represents certain attributes regarding the point at which the sale of a products occur.
 */
@ApiModel(description = "Point Of Sale represents certain attributes regarding the point at which the sale of a products occur.")
